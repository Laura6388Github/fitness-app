  ...
  return (
    <SafeAreaView style={{ backgroundColor: theme.background, flex: 1 }}>
      ...
      >
        ...
        <Text style={{fontSize: 42, fontWeight: 700, fontStyle: 'italic', color: 'white'}}>FITNEST</Text>
        <Text style={{fontSize: 18, fontWeight: 700, fontStyle: 'italic', color: 'white'}}>Exercise with style</Text>
      </View>
