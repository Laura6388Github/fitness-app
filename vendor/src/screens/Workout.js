          ...
          <View style={[style.inputContainer, { backgroundColor: theme.bg }]}>
            ...
            <TouchableOpacity onPress={() => this.RBSheet.open()}>
              <Image
                ...
                style={{ width: width / 16, height: height / 39 }}
              ></Image>
              <RBSheet
                ref={(ref) => {
                  this.RBSheet = ref;
                  ...
                  <View style={{ paddingHorizontal: 20 }}>
                    ...
                    >
                      ...
                      <Text
                        style={[
                          style.subtitle,
                          { color: theme.txt, paddingHorizontal: 120 },
                        ]}
                      >
                        Filter
                      </Text>
                    ...
                    <View style={{ paddingVertical: 15 }}>
                      <Text
                        style={[
                          style.txt1,
                          { color: theme.txt, fontWeight: "600", fontSize: 18 },
                        ]}
                      >
                        Many People Join
                      </Text>
                    ...
                    <ImageBackground
                      source={require("../../assets/image/bgline.png")}
                      style={{ resizeMode: "center" }}
                    >
                      <Image source={theme.line} style={{ marginLeft: 50 }} />
                    </ImageBackground>
                    ...
                    <View style={{ paddingVertical: 30 }}>
                      <TouchableOpacity
                        style={[style.btn, { backgroundColor: theme.icon }]}
                      >
        ...
        >
          ...
          >
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Allworkout")}>
              <Text style={{ color: Colors.btn, fontFamily: "Plus Jakarta Sans" }}>
                See All
              </Text>
            </TouchableOpacity>
          </View>
